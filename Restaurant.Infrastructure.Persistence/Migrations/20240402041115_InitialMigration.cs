    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IngredientesPlato", x => new { x.IngredientesId, x.PlatosId });
                    table.ForeignKey(
                        name: "FK_IngredientesPlato_Ingredientes_IngredientesId",
                        column: x => x.IngredientesId,
                        principalTable: "Ingredientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IngredientesPlato_Platos_PlatosId",
                        column: x => x.PlatosId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IngredientesPlato_PlatosId",
                table: "IngredientesPlato",
                column: "PlatosId");
